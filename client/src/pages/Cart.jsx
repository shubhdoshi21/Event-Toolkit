...
cartItems.forEach(item => console.log("Image URL:", item.image));
          } else {             
  ...
  // Function to go back to the previous page or a specific page
  const handleBack = () => {
    navigate(-1);  // This goes back to the previous page
    // Alternatively, you can navigate to a specific route like: navigate('/home');
  };
          ...
          <div key={item._id} className="bg-gray-800 shadow-2xl rounded-lg p-6 mt-6 flex hover:bg-gray-700 transition duration-300 lg:pl-20">             
            ...
            <div className="w-2/3 pl-10 lg-pl-20">               
              ...
              <p className="text-pupll">                 
                Price: <span className="text-lg font-semibold">₹{item.totalPrice}</span>               
              </p>                
              <div className="space-y-1">                 
                ...
                <p className="font-bold text-lg ">                   
                  ...
                  <button onClick={() => handleDelete(item._id)} className="ml-5">
                    <MdDelete />
                  </button>                 
                </p>                
                <ToastContainer />               
